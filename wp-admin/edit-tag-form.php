...
<div id="message" class="updated">
	...
	<?php if ( isset($wp_http_referer) === true ) { ?>
...
<?php if ( global_terms_enabled() === false ) { ?>
		<tr class="form-field term-slug-wrap">
			 ...
			 */
			$slug = isset( $tag->slug ) === true ? apply_filters( 'editable_slug', $tag->slug, $tag ) : '';
			?>
...
<div class="edit-tag-actions">
	...
	<?php if ( current_user_can( 'delete_term', $tag->term_id ) === true ) : ?>
		<span id="delete-link">
