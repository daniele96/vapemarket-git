...
$plugins_url = current_user_can( 'activate_plugins' ) === true ? admin_url( 'plugins.php' ) : __( 'https://wordpress.org/plugins/' );
$themes_url = current_user_can( 'switch_themes' ) === true ? admin_url( 'themes.php' ) : __( 'https://wordpress.org/themes/' );
